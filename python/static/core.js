    ...
    async start() {
        ...
        this.addStrings({
            zh: { tagline: "Windows 维护可视化控制台",
                  ...
                  footerNote: "基于 tw93/Mole (windows 分支) · 仅本机回环 127.0.0.1:5005",
            ...
            en: { tagline: "Windows maintenance console",
                  ...
                  footerNote: "Based on tw93/Mole (windows branch) · loopback 127.0.0.1:5005 only",
            ...
            ja: { tagline: "Windows メンテナンスコンソール",
                  ...
                  footerNote: "tw93/Mole (windows) ベース · ループバック 127.0.0.1:5005 のみ",
